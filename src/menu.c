...
void updateMenu(App *app, Player *player) {
    ...
    SDL_Rect btnPlay = { centerX, 250, btnW, btnH };
    SDL_Rect btnSettings = { centerX, 370, btnW, btnH };
    SDL_Rect btnExit = { centerX, 490, btnW, btnH };
...
void updatePauseMenu(App *app, Level *level, Player *player) {
    ...
    SDL_Rect btnPauseSettings = { centerX, 370, btnW, btnH };
    SDL_Rect btnPauseExit = { centerX, 490, btnW, btnH };
